...
# sufixo /Index. Analogo ao CPI-US 2026-07-20.
# Sync 2026-08-27: variacao (NSA+SA) removida — mesma decisao do CPI-US
# 2026-07-20. Cada cat vira 1-2 rows: idx NSA + opc. Weight (1x, pareado com
# idx). haver_code (legado) fica NULL em INSERTs novos.
CODE = "IPCA:{cat}"
...
def main():
    ...
    for c in cats:
        ...
        if sp is not None:
            ...
            # series_name=label_idx. Antes eram 2 rows (a outra pareava com
            # o series_name=label, lado var), mas var sumiu.
            sim_sidra_to_sql(
